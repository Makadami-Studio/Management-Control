...
/**
 * @SculptTechProject TODO:
 * Make registerUser from API
 */
    ...
    <SafeAreaView className="flex-1 px-6 pt-10 bg-white">
      <View className="items-center justify-center flex-1 gap-6">
        ...
        <TouchableOpacity
          ...
          onPress={async () => {
            router.push("/(dashboard)/main"); // logujesz się ale narazie bez sprawdzenia co i jak bo nwm jak to zrobić mati ratuj
          }}
        >
